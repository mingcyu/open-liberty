...
public abstract class AbstractTelemetry20ServletFilter extends AbstractTelemetryServletFilter implements Filter {

    private static final TraceComponent tc = Tr.register(AbstractTelemetry20ServletFilter.class);
    ...
    public AbstractTelemetry20ServletFilter() {
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (current != null) {
            ...
            if (current.shouldStart(parentContext, request)) {
                ...
                setHeaderTraceIDHeader(currentSpanContext, (HttpServletResponse) response);
    ...
    protected abstract void setHeaderTraceIDHeader(SpanContext currentSpanContext, HttpServletResponse response);
