...
public class WebConfigParamsLogger
{
    ...
    public static void logWebContextParams(FacesContext facesContext)
    {
        ...
        if (log.isLoggable(Level.INFO))
        {
            ...
            paramValue = facesContext.getExternalContext().getInitParameter("javax.faces.DISABLE_FACESSERVLET_TO_XHTML");
            if (paramValue == null)
            {
            ...
            paramValue = facesContext.getExternalContext().getInitParameter("javax.faces.WEBSOCKET_ENDPOINT_PORT");
            if (paramValue == null)
            {
            ...
            if (paramValue == null)
            {
                log.info("No context init parameter 'org.apache.myfaces.RANDOM_KEY_IN_WEBSOCKET_SESSION_TOKEN' found, using default value 'secureRandom'.");
            }
            else
            {
                boolean found = false;
