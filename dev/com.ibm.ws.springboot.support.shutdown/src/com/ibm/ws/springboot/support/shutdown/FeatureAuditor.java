    ...
    public void postProcessEnvironment(ConfigurableEnvironment env, SpringApplication app) {
        ...
        if ( appHasSpring40 ) {
            ...
            if ( libertyHasSpring15 || libertyHasSpring20  || libertyHasSpring30) {
                ...
                ApplicationTr.error("error.spring4.requires.servlet60.or.higher.application");
                // "CWWKC0277E: Error: Feature servlet-6.0 or higher must be provisioned:
                ...
                ApplicationTr.error("error.spring4.requires.websocket21.or.higher.application");
                // "CWWKC0278E: Error: Feature websocket-2.1 or higher must be provisioned:
