...
public class BasicTest extends CommonTest {
    ...
    public void testClientSecurityNoClientKeystoreTest() {
        ...
        String output = null;
        try {
            ProgramOutput programOutput = commonClientSetUpWithCalcArgs(Constants.MY_TEST_CLIENT, "client_withSecNoKeystore.xml", "CWWKS9582E");
            output = programOutput.getStdout();
        } catch (Exception e) {
            Log.error(c, name.getMethodName(), e, "Unexpected exception was thrown.");
            fail("Exception was thrown: " + e);
        ...
        assertTrue("Client should report an org.omg.CORBA.COMM_FAILURE, org.omg.CORBA.TRANSIENT or NameNotFoundException exception.",
                   output.contains(Constants.CLIENT_CONNECT_EXCEPTION_1)
                                                                                                                                      || output.contains(Constants.CLIENT_CONNECT_EXCEPTION_2)
