...
@WebServlet("/BlockWorkStartupServlet")
public class BlockWorkStartupServlet extends FATServlet {
    private static final String CLASSNAME = BlockWorkStartupServlet.class.getName();
     ...
     */
    @Test
    public void testDefaultStartupBlocksClientsWithStartupBean() throws Exception {
