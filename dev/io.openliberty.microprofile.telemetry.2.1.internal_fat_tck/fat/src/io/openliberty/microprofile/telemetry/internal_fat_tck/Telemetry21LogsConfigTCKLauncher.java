...
@Mode(TestMode.LITE)
public class Telemetry21LogsConfigTCKLauncher {

    private static final String SERVER_NAME = "Telemetry21LogsConfigTCKServer";
    ...
    public void launchTelemetry21LogsConfigTck() throws Exception {
